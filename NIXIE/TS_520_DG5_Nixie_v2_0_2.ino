...
Kenwood DG5 digital display emulator, V2.0.2 - NIXIE version. Uses SmartNixies from TaylorEdge
...
//Display DG5 version on startup
 ...
 Wire.beginTransmission(0x08 +4);       // 5th tube from left
  Wire.write(0);                        //select the Chr register
  Wire.write(2+64);                     //write "2" for the third digit of the version WITH a decimal (set bit 6)
 Wire.endTransmission();                // stop transmitting
