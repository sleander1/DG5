...
Kenwood DG5 digital display emulator, V2.0.1 - LCD version
...
const int numReadings = 10;               // number of readings to average over
...
lcd.begin(16, 2);                   // start LCD
  lcd.print("KV6O DG5  V2.0.1");    // Display version on top line of LCD.  You can change this!
  delay (1000);
